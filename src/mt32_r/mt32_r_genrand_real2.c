 ...
 * $Id: mt32_r_genrand_real2.c,v 1.1.1.2 2015/01/14 00:00:00 seiji Exp seiji $
 */

#include "mt32_r_internal.h"

/*======================================================================*/
double mt32_r_genrand_real2(mt32_context_t *context)
...
{				/* generate a random number in [0:1).   */
    ...
    return (double) y / 4294967296.0;					/* divided by 2^32. */
}
#else				/*......................................*/
{				/* generate a random number in [0:1).   */
...
#else				/*......................................*/
{				/* generate a random number in [0:1).   */
    return (double) mt32_r_genrand_int32(context) / 4294967296.0;	/* divided by 2^32. */
}
#endif
