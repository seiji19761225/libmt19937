 ...
 * $Id: mt32_r_genrand_int31.c,v 1.1.1.2 2015/01/14 00:00:00 seiji Exp seiji $
 */

#include "mt32_r_internal.h"

/*======================================================================*/
int32_t mt32_r_genrand_int31(mt32_context_t *context)
...
#else				/*......................................*/
{				/* generate a random number in [0:2^31-1].*/
    return (int32_t) (mt32_r_genrand_int32(context) >> 0x01);
}
#endif
