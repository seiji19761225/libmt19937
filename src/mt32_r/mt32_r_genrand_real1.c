 ...
 * $Id: mt32_r_genrand_real1.c,v 1.1.1.2 2015/01/14 00:00:00 seiji Exp seiji $
 */

#include "mt32_r_internal.h"

/*======================================================================*/
double mt32_r_genrand_real1(mt32_context_t *context)
...
{				/* generates a random number in [0:1].  */
    ...
    return (double) y / 4294967295.0;					/* divided by 2^32-1. */
}
#else				/*......................................*/
{				/* generates a random number in [0:1].  */
...
#else				/*......................................*/
{				/* generates a random number in [0:1].  */
    return (double) mt32_r_genrand_int32(context) / 4294967295.0;	/* divided by 2^32-1. */
}
#endif
