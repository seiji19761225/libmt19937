 ...
 * $Id: mt64_r_genrand_real2.c,v 1.1.1.2 2015/01/14 00:00:00 seiji Exp seiji $
 */

#include "mt64_r_internal.h"

/*======================================================================*/
double mt64_r_genrand_real2(mt64_context_t *context)
...
{				/* generates a random number in [0:1).  */
    ...
    return (double) (y >> 11) / 9007199254740992.0;
}
#else				/*......................................*/
{				/* generates a random number in [0:1).  */
...
#else				/*......................................*/
{				/* generates a random number in [0:1).  */
    return (double) (mt64_r_genrand_int64(context) >> 11) / 9007199254740992.0;
}
#endif
